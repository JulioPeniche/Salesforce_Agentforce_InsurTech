...
#CONFIGUAÇÃO DE OBJETOS
#AUTOMAÇÃO DE PROCESSOS (FLOW)
#AGENTE DE IA (AGENTFORCE)
#DASHBOARD (TABLEAU)
#DIVULGAÇÃO


Add. Dados e Formatação
...
[Boas-vindas]
 ↓
[Decisão: tipo de seguro]
 ↓
[Coleta de dados]
 ↓
[Criação Lead Salesforce]
 ↓
[Decisão: dados completos?]
 ↓
[Cálculo Cotação]
 ↓
[Decisão: cliente escolhe plano?]
 ↓
